...
const NearMeMapScreen: React.FC = () => {
      ...
      >
        {people.map((person) => {
          ...
          const modeIcon = person.mode === 'fire' 
            ? <PartyModeIcon />  
            : <RomanceModeIcon />
          const touchIcon = person.touched ? <TouchProfileIcon /> : undefined;
          const matchIcon = person.touchMatch ? <MatchTouchIcon /> : undefined;
...
export default NearMeMapScreen;
